...
<div class="container"> 		
	...
	<iframe id="fengjing" name="fengjing" src="<%=basePath%>/User/Scenic?action=showList&stid=${firstscenictypeid}&pageNow=1"  style="float:right;width:712px;height:665px;border:1px solid #cccccc;background-color:white;"></iframe>

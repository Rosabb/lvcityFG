	...
	<div class="header_bottom">
            ...
            <li><a href="<%=basePath%>historic/show.do">历史</a></li>     
                ...
                <li><a href="<%=basePath%>User/leave.jsp">留言</a></li>   
				 ...
				 <li><a href="<%=basePath%>User/team.jsp">团队介绍</a></li>      

                <li><a href="<%=basePath%>User/connection.jsp">联系我们</a></li>
                ...
                <c:if test="${!empty scenicList }">
					<c:forEach items="${scenicList}" var="scenic" varStatus="number">
						<div class="fl${number.count } fldiv">
		                    ...
		                    <a href="User/Scenic?action=show"><img src="${scenic.image }" width="75" height="76" alt="" title=""></a>
	                       ...
	                       <c:if test="${!empty foodList }">
								<c:forEach items="${foodList}" var="food">
									<li>
										...
										<div class="pic">
										<img src="${food.image }" width="231" height="151" /></div></a>
		                           	</li>
								</c:forEach>
							</c:if>
						</ul>
...
<div class="footer"> 
	...
	<p><a href="<%=basePath%>User/Index">首页</a> | <a href="<%=basePath%>historic/show.do">历史</a> | <a href="<%=basePath%>User/Scenic?action=show">风景</a> | <a href="<%=basePath%>tourism/showtourism.do">旅游</a> | <a href="<%=basePath%>User/Food?action=show">美食</a> | <a href="<%=basePath%>noticetype/show.do">动态</a> | <a href="<%=basePath%>User/leave.jsp">留言</a>| <a href="<%=basePath%>User/connection.jsp">联系我们</a></p>
